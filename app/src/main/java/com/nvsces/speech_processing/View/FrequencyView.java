    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i=0; i<height; i++) {
           ...
           // Log.d("TEST", String.valueOf(j));
            ...
            int c = getInterpolatedColor(colorRainbow, db*0.009f);
            paint.setColor(c);
           ...
           // Log.d("TEST", String.valueOf(db));
            ...
            this.canvas.drawPoint(x, y, paint);
            this.canvas.drawPoint(x2, y, paint);
            this.canvas.drawPoint(x2, y, paint);// make color brighter
        ...
        for (int i=0; i<height; i++) {
            int c = getInterpolatedColor(colorRainbow, ((float) i)/height);
            paint.setColor(c);
